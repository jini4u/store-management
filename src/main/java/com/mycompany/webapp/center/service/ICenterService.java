...
public interface ICenterService {
	...
	//센터등록
	int insertCenter(CenterVO centerVO);
	//센터조회
	List<CenterVO> centerList(Pager pager);
	...
	//센터수정
	int centerUpdate(CenterVO centerVO);

	//센터 사진 등록
	int addCenterImage(String fileDetail, int centerCode, int uploadUserCode, List<MultipartFile> files);

	//센터 검색
	List<CenterVO> findCenter(Pager filterPager, String keyword, String keywordType);
