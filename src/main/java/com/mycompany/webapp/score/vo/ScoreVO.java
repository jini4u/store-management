...
public class ScoreVO {
	...
	public String toString() {
		return "ScoreVO [checkYear=" + checkYear + ", checkSeason=" + checkSeason + ", checkGroupCode=" + checkGroupCode
				...
				+ ", checkScore=" + checkScore + ", centerName=" + centerName + ", checkDetailCode=" + checkDetailCode
				+ ", centerCode=" + centerCode + ", userCode=" + userCode + ", arrayCheckGroupCode="
				+ Arrays.toString(arrayCheckGroupCode) + ", arrayCheckDetailCode="
				+ Arrays.toString(arrayCheckDetailCode) + ", arrayScore=" + Arrays.toString(arrayScore)
