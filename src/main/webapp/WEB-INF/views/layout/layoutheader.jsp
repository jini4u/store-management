	...
	<li><a id="aTag" href="/logout">로그아웃</a></li>
              ...
              <div class="dropdown">
                <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false">
                  <a class="mypage"> <img src="${pageContext.request.contextPath}/resources/images/user.png"></a>
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <li><a class="aTag dropdown-item" data-toggle="modal" data-backdrop="static" href="#pwUpdate">비밀번호 변경</a></li>
