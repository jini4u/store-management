...
<div class="search-box">
   <form action="${pageContext.request.contextPath}/manager/managerList" method="get">
...
<!-- 모달창 -->
<button id="testBtn" class="pinkButton">등록</button>
            ...
            <form id="insertform">
               ...
               <table class="rowTable" id="mgrdetailtable">
                  <tr>
                     ...
                     <td><input type="hidden" name="userCode" id="userCode">
                  ...
                  <tr>
                     ...
                     <td><input type="date" name="userHireDate" id="userHireDate"
                        disabled></td>
                     <th scope="row">팀코드</th>
                     <td><input type="text" name="userTeamCode" id="userTeamCode"
                        disabled></td>
                  </tr>
