...
<div class='uploadbutton'>
	<a
		href='${pageContext.request.contextPath}/resources/templates/template_점수.xlsx'
		download="" class="greyButton btn btn btn-primary btn-lg">양식파일
		다운로드</a>
	<form id="file-upload-form">
		<div id="invalid-file-div"></div>
...
<table class="verticalTable">
	...
	<c:forEach items="${historyMapList}" var="historyMap">
		<tr>
			...
			<td><a href='/file/score_${historyMap.originalName}'
...
<div class="center-pagging">
	<ul class="pagination">
		<li><a class="innerPager first" href="scoreupload?pageNo=1">처음</a></li>
		...
		<c:forEach var="i" begin="${pager.startPageNo}"
			...
			<li><c:if test="${pager.pageNo != i}">
					<a class="innerPager num" href="scoreupload?pageNo=${i}">${i}</a>
				</c:if></li>
			<li><c:if test="${pager.pageNo == i}">
...
<script
	src="${pageContext.request.contextPath}/resources/js/score/scoreupload.js"></script>