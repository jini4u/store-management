function loadingMask() {
	...
	//화면에 출력할 마스크를 설정해줍니다.
	var maskDiv = "<div id='mask' style='position:absolute; z-index:9000; background-color:#FFFFFF; display:flex; align-items: center; justify-content: center; left:0; top:0;'></div>";
	var loadingImg = '';
